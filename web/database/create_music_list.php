...
<body>
    ...
    <h1>Add Music</h1>
    <br><br>
<form method="POST" name="create_music_list" id="music_list"
      action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" >   
        <label for="title">Title: </label> 
        <input type="text" name="title" id="title" size="40" required><br><br>
        
        <label for="artist">Artist: </label>        
        <input type="text" name="artist" id="artist" size="50" required><br><br>
        ...
        <?php 
            ...
            if (isset($_POST)) {
               $sql = pg_query_params($db_con, "INSERT INTO scripture (title, artist, genre, year_published) VALUES ($1, $2, $3, $4) returning id", array($_POST['title'], $_POST['director'], $_POST['genre'], $_POST['year_published']));
